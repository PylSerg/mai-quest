...
export const SCENARIOS_PRESETS = [
	{
		title: 'Таємниці Тамріеля',
		setting: 'dark fantasy middle ages',
		day: 1,
		locationName: 'Таверна «Гарцююча кобила»',
		locationDescription:
			"Таверна в Вайтрані. Усередині пахне деревиною, елем та випічкою. Два поверхи.",
		location: 'Таверна «Гарцююча кобила»',
		timeOfDay: 'Ніч',
		objectives: 'Спитати у трактирщика про нові чутки',
		memory: '• День 1, Ніч, Таверна «Гарцююча кобила»: Ви сидете за столиком.',
		locations: [
			{
				id: 'loc_preset_1',
				name: 'Таверна «Гарцююча кобила»',
				description:
					"Таверна «Гарцююча кобила». Таверна в якій можна відпочити, випити та поїсти."
			}
		],
		pName: 'Ховард',
		pSurname: 'Сталева Рука',
		pRace: 'Норд',
		pGender: 'Чоловіча',
		pAge: 35,
		pRole: 'Шукач пригод',
		pPersonality: 'Сміливий, допитливий',
		pApp: 'Шкіряна броня, меч на поясі, щит на спині',
		cName: 'Емілі',
		...
		cAge: 30,
		cRole: 'Баронеса',
		cPersonality: 'Горда, допитлива, кмітлива, імпульсивна та закохана у стародавні таємниці, гостра на язик',
		cApp: 'Шкіряна коротка спідниця з корсетом, лук та сагайдак зі стрілами на спині'
	}
];
